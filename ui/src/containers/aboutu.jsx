    ...
    <>
      ...
      md:py-14 sm:py-12 py-10 lg:px-24 md:px-16 sm:px-6 px-4 flex-warp-reverse">
            ...
            <div className="w-full h-auto lg:text-start md:text-start sm:text-start text-center">
                  <h6 className="text-lg font-medium text-black-200 flex items-center lg:justify-start
                  ...
                  <h1 className="lg:text-3xl md:text-3xl sm:text-2xl text-xl font-semibold
                   text-black-200 mb-4 leading-normal lg:pe-5 md:pe-4 sm:pe-1 pe-0">
                    Effortless Strength, Timely Gain: Building Better Bodies, Faster
                  </h1>
                  <p className="lg:text-base md:text-base sm:text-sm text-sm text-black-500
                   font-medium mb-4">
                      Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nemo quibusdam,
                       voluptatibus facilis nobis corrupti commodi iste sit itaque, similique quae 
                       soluta, quam rem earum. Corrupti, ut. Dignissimos esse facilis maiores!
                  </p>
